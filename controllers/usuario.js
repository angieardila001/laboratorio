...
const usuarioPost=async(req,res)=>{ //añadir
    const{nombre,documento,direccion,ciudad,contacto,telefono,email,rol,password}=req.body
    const usuario= new Usuario({nombre,documento,direccion,ciudad,contacto,telefono,email,rol,password})
